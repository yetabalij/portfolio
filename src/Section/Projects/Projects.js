      ...
      <div>
        ...
        <div className="flex flex-col gap-y-4">
          <div className="sm:flex justify-center">
            <div className="sm:w-1/2 bg-gradient-to-r from-cyan-500 to-[#6387F2] justify-center items-center flex flex-col py-2">
          ...
          <div className="sm:flex justify-center">
            ...
            <div className="sm:w-1/2 bg-gradient-to-r from-cyan-500 to-blue-500 justify-center items-center flex flex-col py-2">
              <h3 className="text-primary-color text-2xl font-medium">
                RealTimeBook
              </h3>
              <p className="px-12 py-4 font-light">
